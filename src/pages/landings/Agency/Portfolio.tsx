...
const Portfolios = ({ portfolios }: PortfolioProps) => {
    return (
        <section className="section py-lg-5 py-4 mb-5 mb-sm-0 position-relative" id="portfolio">
            <Container>
                                ...
                                <div className="bg-gray-50 pt-5 mt-4 mt-sm-5 rounded feature-item">
                                    ...
                                    <div className="overlay">
                                        <Link
                                            ...
                                            className="btn btn-secondary btn-sm btn-view shadow-lg">
                                            View Project
                ...
                <Row className="mt-6 justify-content-center">
                    <Col xs="auto">
                        <Link to="/pages/portfolio/grid" className="btn btn-outline-secondary mb-2">
                            Explore All Work
